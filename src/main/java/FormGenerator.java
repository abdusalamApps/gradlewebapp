...
public class FormGenerator {
	...
	public String generateTable(String[] columns, List<AllInfoRow> allInforList, String cssTag) {
		...
		htmlBuilder.append("<html><head>").append(cssTag);
		...
		for (String column : columns) {
			htmlBuilder.append("<th>").append(column).append("</th>");
		}
		htmlBuilder.append("</tr>");
		
		for (AllInfoRow row : allInforList) {
			htmlBuilder.append("<tr>");
			htmlBuilder.append("<td>").append(row.name).append("</td>");
			htmlBuilder.append("<td>").append(row.answer00).append("</td>");
			htmlBuilder.append("<td>").append(row.answer01).append("</td>");
			htmlBuilder.append("<td>").append(row.answer11).append("</td>");
			htmlBuilder.append("<td>").append(row.answer12).append("</td>");
			htmlBuilder.append("<td>").append(row.answer13).append("</td>");
			htmlBuilder.append("<td>").append(row.answer14).append("</td>");
			htmlBuilder.append("</tr>");
		}
